...
<div class="post-author">
    ...
    <div>
        ...
        <div>
            ...
            <a href="<?php echo get_author_posts_url($select_lauteur_array['ID'], $select_lauteur_array['user_nicename'] ); ?>" class="btn">En savoir plus sur l'intervenant</a>
        </div>
   </div>
</div>
<?php } ?>
    ...
    <div>
        ...
        <div>
            ...
            <?php if( get_field('site_internet_auteur') ){ ?>
                <a href="<?php the_field('site_internet_auteur'); ?>" class="btn" target="_blank">En savoir plus sur l'intervenant</a>
            <?php } ?>
        </div>
   </div>
</div>
